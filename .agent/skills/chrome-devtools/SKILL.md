...
elif [ -d ".agent/skills/chrome-devtools/scripts" ]; then
  SKILL_DIR=".agent/skills/chrome-devtools/scripts"
fi
...
- `./resources/cdp-domains.md` - Chrome DevTools Protocol domains
- `./resources/puppeteer-reference.md` - Puppeteer API patterns
- `./resources/performance-guide.md` - Core Web Vitals optimization
