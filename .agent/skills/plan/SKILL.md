...
Load: `resources/workflow-modes.md` for auto-detection logic, per-mode workflows, context reminders.
...
### 1. Research & Analysis
Load: `resources/research-phase.md`
**Skip if:** Fast mode or provided with researcher reports

### 2. Codebase Understanding
Load: `resources/codebase-understanding.md`
**Skip if:** Provided with scout reports

### 3. Solution Design
Load: `resources/solution-design.md`

### 4. Plan Creation & Organization
Load: `resources/plan-organization.md`

### 5. Task Breakdown & Output Standards
Load: `resources/output-standards.md`
...
Load: `resources/task-management.md` for hydration pattern, TaskCreate patterns, cook handoff protocol.
...
|------------|-----------|---------|
| `/plan archive` | `resources/archive-workflow.md` | Archive plans + write journal entries |
| `/plan red-team` | `resources/red-team-workflow.md` | Adversarial plan review with hostile reviewers |
| `/plan validate` | `resources/validate-workflow.md` | Validate plan with critical questions interview |
