...
- [CLI Commands](./resources/cli-commands.md) - `gkg index`, `gkg server`, `gkg remove`, `gkg clean`
- [MCP Tools](./resources/mcp-tools.md) - 7 tools for AI integration
- [HTTP API](./resources/http-api.md) - REST endpoints for querying
- [Language Details](./resources/language-support.md) - Supported features per language
