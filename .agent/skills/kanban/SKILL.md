...
- `/kanban <dir>` - View dashboard for specific directory
...
The skill is located at `.agent/skills/plans-kanban/`.
...
```json
{
  "command": "node .agent/skills/plans-kanban/scripts/server.cjs --dir \"./plans\" --host 0.0.0.0 --open --foreground",
