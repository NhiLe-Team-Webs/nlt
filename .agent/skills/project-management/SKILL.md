...
### 1. Task Operations
Load: `resources/task-operations.md`
...
Load: `resources/hydration-workflow.md`
...
### 3. Progress Tracking
Load: `resources/progress-tracking.md`
...
Load: `resources/documentation-triggers.md`
...
Delegate to `.agent/agents/agent-docs-manager/agent-docs-manager.md` instructions for actual updates.

### 5. Status Reporting
Load: `resources/reporting-patterns.md`
...
- `skill-plan` — Creates implementation plans (planning phase)
- `skill-cook` — Implements plans (execution phase, invokes project-manager at finalize)
