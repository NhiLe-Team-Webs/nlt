...
|----------|------|-----------|
| Receiving feedback | Unclear feedback, external reviewers, needs prioritization | `resources/code-review-reception.md` |
| Requesting review | After tasks, before merge, stuck on problem | `resources/requesting-code-review.md` |
| Verification gates | Before any completion claim, commit, PR | `resources/verification-before-completion.md` |
| Edge case scouting | After implementation, before review | `resources/edge-case-scouting.md` |
| **Task-managed reviews** | Multi-file features (3+ files), parallel reviewers, fix cycles | `resources/task-management-reviews.md` |
...
**Full protocol:** `resources/code-review-reception.md`
...
**Full protocol:** `resources/requesting-code-review.md`
...
**Full protocol:** `resources/edge-case-scouting.md`
...
**Full protocol:** `resources/task-management-reviews.md`
...
**Full protocol:** `resources/verification-before-completion.md`
...
|------------|-----------|---------|
| `/code-review codebase` | `resources/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/code-review codebase parallel` | `resources/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |
