...
- `resources/agent-types-and-architecture.md` — Agent types, workflows, custom agents
- `resources/tools-and-mcp-integration.md` — Custom tools, MCP, tool filtering
- `resources/multi-agent-and-a2a-protocol.md` — Sub-agents, A2A, coordinator patterns
- `resources/sessions-state-memory-artifacts.md` — State, artifacts, sessions, memory
- `resources/callbacks-plugins-observability.md` — Lifecycle hooks, plugins, tracing
- `resources/evaluation-testing-cli.md` — adk eval, CLI, evalset format
- `resources/deployment-cloud-run-vertex-gke.md` — Cloud Run, Vertex AI, GKE
