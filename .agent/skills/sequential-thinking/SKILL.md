...
- `resources/core-patterns.md` - Revision & branching patterns
- `resources/examples-api.md` - API design example
- `resources/examples-debug.md` - Debugging example
- `resources/examples-architecture.md` - Architecture decision example
- `resources/advanced-techniques.md` - Spiral refinement, hypothesis testing, convergence
- `resources/advanced-strategies.md` - Uncertainty, revision cascades, meta-thinking
