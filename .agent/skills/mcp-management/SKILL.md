...
Load `.agent/agents/agent-mcp-manager/agent-mcp-manager.md` instructions when Gemini CLI unavailable. Subagent discovers tools, selects relevant ones, executes tasks, reports back.
...
The `.agent/agents/agent-mcp-manager/agent-mcp-manager.md` agent uses this skill to:
