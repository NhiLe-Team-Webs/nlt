...
**[context7-patterns.md](./resources/context7-patterns.md)** - URL patterns, known repositories

**[errors.md](./resources/errors.md)** - Error handling, fallback strategies

**[advanced.md](./resources/advanced.md)** - Edge cases, versioning, multi-language
