...
```bash
python3 .agent/skills/threejs/scripts/search.py "<query>" [--domain <domain>] [-n <max_results>]
```
...
python3 .agent/skills/threejs/scripts/search.py "particle compute webgpu"

# Search API for camera classes
python3 .agent/skills/threejs/scripts/search.py "camera" --domain api

# Get examples for a use case
python3 .agent/skills/threejs/scripts/search.py "product configurator" --use-case

# Filter by category
python3 .agent/skills/threejs/scripts/search.py --category webgpu -n 10

# Filter by complexity
python3 .agent/skills/threejs/scripts/search.py --complexity high -n 5
```
...
- `resources/00-fundamentals.md` - Core concepts, scene graph
- `resources/01-getting-started.md` - Setup, basic rendering

### Level 2: Common Tasks
- `resources/02-loaders.md` - GLTF, FBX, OBJ loaders
- `resources/03-textures.md` - Texture types, mapping
- `resources/04-cameras.md` - Camera types, controls
- `resources/05-lights.md` - Light types, shadows
- `resources/06-animations.md` - AnimationMixer, clips
- `resources/11-materials.md` - PBR, standard materials
- `resources/18-geometry.md` - BufferGeometry, primitives

### Level 3: Interactive
- `resources/08-interaction.md` - Raycasting, picking
- `resources/09-postprocessing.md` - Bloom, SSAO, SSR
- `resources/10-controls.md` - OrbitControls, etc.

### Level 4: Advanced
- `resources/12-performance.md` - Instancing, LOD, batching
- `resources/13-node-materials.md` - TSL shader graphs
- `resources/17-shader.md` - Custom GLSL shaders

### Level 5: Specialized
- `resources/14-physics-vr.md` - Physics, WebXR
- `resources/16-webgpu.md` - WebGPU, compute shaders
