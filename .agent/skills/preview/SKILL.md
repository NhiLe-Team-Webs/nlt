...
2. **Generation flags** (`--explain`, `--slides`, `--diagram`, `--ascii`) → Generation mode. Load `resources/generation-modes.md`
...
4. **Resolved path exists on filesystem** → View mode. Load `resources/view-mode.md`
