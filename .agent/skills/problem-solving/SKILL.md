...
|---------------|-----------|-----------|
| Same thing implemented 5+ ways, growing special cases | **Simplification Cascades** | `resources/simplification-cascades.md` |
| Conventional solutions inadequate, need breakthrough | **Collision-Zone Thinking** | `resources/collision-zone-thinking.md` |
| Same issue in different places, reinventing wheels | **Meta-Pattern Recognition** | `resources/meta-pattern-recognition.md` |
| Solution feels forced, "must be done this way" | **Inversion Exercise** | `resources/inversion-exercise.md` |
| Will this work at production? Edge cases unclear? | **Scale Game** | `resources/scale-game.md` |
| Unsure which technique to use | **When Stuck** | `resources/when-stuck.md` |
...
2. **Load detailed reference** - Read specific technique from `resources/`
...
- `resources/when-stuck.md` - Dispatch flowchart and decision tree
- `resources/simplification-cascades.md` - Cascade detection and extraction
- `resources/collision-zone-thinking.md` - Metaphor collision process
- `resources/meta-pattern-recognition.md` - Pattern abstraction techniques
- `resources/inversion-exercise.md` - Assumption flipping methodology
- `resources/scale-game.md` - Extreme testing procedures
- `resources/attribution.md` - Source and adaptation notes
