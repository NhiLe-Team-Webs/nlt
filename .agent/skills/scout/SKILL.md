...
## Arguments
- Default: Scout using built-in Explore subagents in parallel (`./resources/internal-scouting.md`)
- `ext`: Scout using external Gemini/OpenCode CLI tools in parallel (`./resources/external-scouting.md`)
...
- See `resources/task-management-scouting.md` for patterns and examples

### 4. Spawn Parallel Agents
Load appropriate reference based on decision tree:
- **Internal (Default):** `resources/internal-scouting.md` (Explore subagents)
- **External:** `resources/external-scouting.md` (Gemini/OpenCode)
...
- `resources/internal-scouting.md` - Using Explore subagents
- `resources/external-scouting.md` - Using Gemini/OpenCode CLI
- `resources/task-management-scouting.md` - Claude Task patterns for scout coordination
