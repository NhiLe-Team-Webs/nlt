...
Full anatomy & requirements: `resources/anatomy-and-requirements.md`

## Creation Workflow

Follow the 7-step process in `resources/creation-workflow.md`:
...
Detailed scoring algorithms: `resources/skillmark-benchmark-criteria.md`
Optimization patterns: `resources/benchmark-optimization-guide.md`
...
- **Checklist**: `resources/validation-checklist.md`
- **Metadata**: `resources/metadata-quality-criteria.md`
- **Tokens**: `resources/token-efficiency-criteria.md`
- **Scripts**: `resources/script-quality-criteria.md`
- **Structure**: `resources/structure-organization-criteria.md`
...
- **Overview**: `resources/plugin-marketplace-overview.md`
- **Schema**: `resources/plugin-marketplace-schema.md`
- **Sources**: `resources/plugin-marketplace-sources.md`
- **Hosting**: `resources/plugin-marketplace-hosting.md`
- **Troubleshooting**: `resources/plugin-marketplace-troubleshooting.md`
