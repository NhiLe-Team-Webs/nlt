...
## Collaboration Tools
- Consult the `.agent/agents/agent-planner/agent-planner.md` agent to research industry best practices and find proven solutions
- Engage the `.agent/agents/agent-docs-manager/agent-docs-manager.md` agent to understand existing project implementation and constraints
- Use native web search capability to find efficient approaches and learn from others' experiences
- Use `skill-docs-seeker` skill to read latest documentation of external plugins/packages
- Leverage `skill-ai-multimodal` skill to analyze visual materials and mockups
- Query `psql` command to understand current database structure and existing data
- Employ `skill-sequential-thinking` skill for complex problem-solving that requires structured analysis

## Your Process
1. **Scout Phase**: Use `skill-scout` skill to discover relevant files and code patterns, read relevant docs in `<project-dir>/docs` directory, to understand the current state of the project
...
## Report Output
Save reports using pattern: `plans/reports/{type}-YYMMDD-HHMM-{slug}.md` The pattern includes the full path and computed date.
