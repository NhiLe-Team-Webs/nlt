...
- `--full`: Load `resources/workflow-full.md`
- `--auto`: Load `resources/workflow-auto.md`
- `--fast`: Load `resources/workflow-fast.md`
- `--parallel`: Load `resources/workflow-parallel.md`

All modes share: Load `resources/shared-phases.md` for implementation through final report.

## Step 0: Git Init (ALL modes)

Check if Git initialized. If not:
- `--full`: Ask user if they want to init → `.agent/agents/agent-git-manager/agent-git-manager.md` instructions (`main` branch)
- Others: Auto-init via `.agent/agents/agent-git-manager/agent-git-manager.md` instructions (`main` branch)
...
### Planning Phase
Activate **skill-plan** skill with mode-appropriate flag:
...
Activate **skill-cook** skill with the plan path and mode-appropriate flag:
...
- `resources/workflow-full.md` - Full interactive workflow
- `resources/workflow-auto.md` - Auto workflow (default)
- `resources/workflow-fast.md` - Fast workflow
- `resources/workflow-parallel.md` - Parallel workflow
- `resources/shared-phases.md` - Common phases (implementation → final report)
